...
PG_CMDTAG(CMDTAG_DELETE_RULE, "DELETE RULE", false, false, true)
...
PG_CMDTAG(CMDTAG_INSERT_RULE, "INSERT RULE", false, false, true)
...
PG_CMDTAG(CMDTAG_UPDATE_RULE, "UPDATE RULE", false, false, true)
